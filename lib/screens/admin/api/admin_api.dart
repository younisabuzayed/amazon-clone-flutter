...
class AdminAPI {
  ...
  void pushNotification({
    ...
    try {
      ...
      // print(token);
      http.Response res =
          await http.post(Uri.parse('$uri/api/v1/admin/notification'),
              headers: {
                'Content-Type': 'application/json; charset=UTF-8',
                // 'x-auth-token': user.token,
              },
              body: jsonEncode({
                'token':
                    'dLqG3KTuTayetfzGej3yRv:APA91bFKR5PA0P2-KzQ_rz85zCKCwuNhXX--YxG58kAuVfX8GOHXO181sbYl6mUq0p21FuWjGX89rLvCyK_KKZ0GN6iusgITDP2lElNFswJZK28_5-Jw2EukBbIyBXoj1Ex8b0Wzuu5K',
                'message': {
